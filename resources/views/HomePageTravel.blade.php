...
<body>
        ...
        <div class='finder'>
          <form>
              <h3>Поиск путешествия</h3>
                ...
                <input class='btn finder_btn' type="submit" value="Найти путешествие"/>
            </form>
            </div>          
        </div>
          <img src="thousand-01.png"alt="img"/>    
    </div>
     </container>
    </main>
    ...
    <container>
        ...
        <section class="section">
            ...
            <h2>JourneyCard</h2>
                <div>
                    <img src="/Raja ampat.png" alt="Card" />
                    <h3>Название тура</h3>
        ...
        <section class="section">
            ...
            <h2>JourneyCard</h2>
                <div>
                    <img src="/Fanjingshan.png" alt="Card" />
                    <h3>Название тура</h3>
