        ...
        <ul class='navbar__inner mb-0'>
            ...
            <div class="dropdown">
                <a href="{{ route('account.profile') }}"
                    ...
                    <img src="@if(Auth::user()->avatar){!!Auth::user()->avatar!!}@else{!! asset('images/default_avatar.png') !!}@endif"
                        width="38" height="38" class="rounded-circle">
                </a>
                <ul class="dropdown-menu text-small shadow text-small dropdown-menu" data-popper-placement="bottom-end"
